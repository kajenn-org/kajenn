...
Measured on 2026-09-08 on macOS Darwin 25.6.0, arm64, Python 3.14.6. The numbers
below are one run on one machine; read the limits at the bottom of the page
