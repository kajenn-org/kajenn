# Task thermometers (termometri) — open decisions

**Version**: 0.1 · **Last Updated**: 2026-09-17 · **Status**: 🔴 DA REVISIONARE

Source report: `kajenn-meta/verification/10_server/080_task-thermometers.md`.
...
No row with verdict `DIVERGE` or `SILENT`.
